...
void experiment (bool enableCtsRts)
{
  ...
  Ptr<Ipv4FlowProbe> probe1 = nodes.Get(1)->GetObject<Ipv4FlowProbe>();
  Ptr<Ipv4FlowProbe> probe2 = nodes.Get(2)->GetObject<Ipv4FlowProbe>();

  Ipv4FlowProbe::Stats stats0 = probe0->GetStats();
  std::cout << "test" << "\n";
  for (std::map<FlowId, FlowProbe::FlowStats>::const_iterator i = stats0.begin (); i != stats0.end (); ++i)
    {
      ...
      if (i->first > 2)
        {
          ...
          std::cout << "  Delay from First Probe " << i->second.delayFromFirstProbeSum << "\n";
        }
    }

  //std::cout << " Packets Probe0: " << probe0.packets << "\n";
  //std::cout << " Packets Probe0: " << probe0.delayFromFirstProbeSum << "\n";
      ...
      if (i->first > 2)
        {
          ...
          //std::cout << "  Rx Bytes:   " << i->second.packets << "\n";
          std::cout << "  Throughput: " << i->second.rxBytes * 8.0 / 9.0 / 1000 / 1000  << " Mbps\n";
        }
    }

   //std::map<FlowId, FlowProbe::FlowStats>::const_iterator I = stats.begin ();
